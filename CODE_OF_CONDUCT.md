...
- **AI tools must not replace humain-to-human contributons.** AI generated prose must not be used in code comments, commit messages, github issues or pull requests descriptions and comments. AI generated prose tend to require time and energy to sort trough, do not expect fellow contributors to do it for you. You must understand what you submit, explaining it in your own words proves that you do, while AI prose raises doubts.
...
- **Limit AI tools for reviewing.** As with creating code, reviewers may use AI tools to assist in providing feedback, but not to wholly automate the review process. Particularly, AI may not make the final determination on whether a contribution is accepted, and review suggestions from AI must be verified by the reviewer and explained in their own words. Reviewers must disclose the use of AI tools and avoid using them if asked to do so by the contributor. This point also applies when creating an issue for a bug found thanks to AI.
